...
I spent some time reading about Lua Programmation Language (especially next() and setmetatable() functions), trying instructions and dealing with errors. But finally i found that injecting a table that contains a metamethod \_\_call with a function can give us what we want. So i got our final simple payload :
```
